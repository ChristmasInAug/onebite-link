...
export default function LinkCard({ link }: LinkCardProps) {
  ...
  return (
    <a
      ...
      className="group flex flex-col gap-3 rounded-xl bg-[var(--surface)] p-6 shadow-[0_1px_3px_rgba(0,0,0,0.04)] transition-shadow hover:shadow-[0_4px_16px_rgba(0,0,0,0.08)]"
    >
