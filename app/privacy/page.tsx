...
const OPERATOR_NAME = "박정하";
const CONTACT_EMAIL = "barkha1121@gmail.com";
...
export default function PrivacyPolicyPage() {
  return (
    <main className="mx-auto max-w-3xl px-6 py-12 text-[var(--text)]">
      ...
      <nav
        aria-label="목차"
        className="mb-12 rounded-lg border border-[var(--border)] bg-[var(--surface)] p-5"
      >
      ...
      <section id="s9" className="mb-10 scroll-mt-20">
        ...
        <div className="rounded-lg border border-[var(--border)] bg-[var(--surface)] p-4 leading-relaxed">
          <p>
